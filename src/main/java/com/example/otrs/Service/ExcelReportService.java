...
public class ExcelReportService {
    ...
    public void generateExcelReport(HttpServletResponse response, Integer status) throws IOException {
        ...
        for (TicketDTO ticket : tickets) {
            ...
            setCellValue(row.createCell(0), ticket.getTicketId());
            setCellValue(row.createCell(1), ticket.getSender());
            setCellValue(row.createCell(2), ticket.getAssignee());
            setCellValue(row.createCell(3), ticket.getReportedDateTime());
            setCellValue(row.createCell(4), ticket.getEmergencyLevel());
            setCellValue(row.createCell(5), ticket.getLocation());
            setCellValue(row.createCell(6), ticket.getBranchDivision());
            setCellValue(row.createCell(7), ticket.getIssueType());
            setCellValue(row.createCell(8), ticket.getIssueCategory());
            setCellValue(row.createCell(9), ticket.getContactNo());
            setCellValue(row.createCell(10), ticket.getSerialNo());
            setCellValue(row.createCell(11), ticket.getIsWorkingPc());
            setCellValue(row.createCell(12), ticket.getIp());
            setCellValue(row.createCell(13), ticket.getIssueDesAndRemarks());
            setCellValue(row.createCell(14), ticket.getAssigneeResponseDateTime());
            setCellValue(row.createCell(15), ticket.getResolvedDateTime());
            setCellValue(row.createCell(16), ticket.getResolutionPeriod());
            setCellValue(row.createCell(17), ticket.getCompletedPercentage());
            setCellValue(row.createCell(18), ticket.getAssigneeComments());
            setCellValue(row.createCell(19), ticket.getLastUpdatedUser());
            setCellValue(row.createCell(20), ticket.getLastUpdatedDateTime());
            setCellValue(row.createCell(21), ticket.getStatus());
        }
